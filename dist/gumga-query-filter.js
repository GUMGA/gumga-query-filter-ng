...
function HQLFactory($filter) {
  ...
  function hqlObjectCreator() {
    ...
    hqlObjects['contains'] = { hql: ' contains ', label: ' cont\xE9m ', before: ' like \'%', after: '%\'' };
    hqlObjects['not_contains'] = { hql: ' not_contains ', label: ' n\xE3o cont\xE9m ', before: ' not like \'%', after: '%\'' };
    hqlObjects['starts_with'] = { hql: ' starts_with ', label: ' come\xE7a com ', before: ' like \'', after: '%\'' };
...
},{"./hql-factory.js":1,"./query-model-factory.js":3}],3:[function(require,module,exports){
'use strict';
  ...
  return {
    ...
    link: function link($scope, $element, $attrs, $ctrl, $transclude) {
      ...
      $scope.$on('filter-items', function (err, data) {
        ...
        $timeout(function () {
          return $scope.search({ param: HQLFactory.createHql($scope.controlMap) });
        });
      });
      ...
      function callSearch(e, typeSearch) {
        ...
        if (typeSearch == "remove") {
          var param = positionCondition == 0 ? {} : HQLFactory.createHql($scope.controlMap);
...
},{"./filter-core.js":4,"./filter.js":5}],7:[function(require,module,exports){
...
},{"./factory/index.js":2,"./filter/index.js":6,"./query/query.js":8}],8:[function(require,module,exports){
'use strict';
  ...
  function controller($scope, $element, $attrs, $transclude) {
    ...
    $transclude(function (transcludeElement) {
      ...
      [].slice.call(transcludeElement).forEach(function (value) {
        ...
        ctrl.mapFields[field] = { checkbox: checkbox, label: label, field: field };
      });
    ...
    function doSearch(param) {
      ...
      var field = Object.keys(ctrl.mapFields).filter(function (value) {
      ...
      ctrl.search({ field: field, param: param });
    }
