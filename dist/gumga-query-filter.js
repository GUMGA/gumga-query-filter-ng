    ...
    link: function link($scope, $element, $attrs, $ctrl, $transclude) {
      ...
      function isAnyQueryNotOk() {
        return Object.keys($scope.controlMap).filter(function (intern) {
          return (!$scope.controlMap[intern].isEVERYTHING_NEEDED() || $scope.controlMap[intern].isUPDATING_ATTRIBUTE() || $scope.controlMap[intern].isUPDATING_CONDITION() || $scope.controlMap[intern].isUPDATING_VALUE()) && $scope.controlMap[intern].active;
